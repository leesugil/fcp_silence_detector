...
def main():
    ...
    parser.add_argument("--polish_duration", type=float, default=0.4, help="Maximum non-silence duration in seconds")
    parser.add_argument("--buffer_duration", type=float, default=0.5, help="Amount to reduce silence duration in seconds. (Should not be greater than duration)")
